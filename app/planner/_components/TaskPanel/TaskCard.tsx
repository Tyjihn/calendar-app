...
export default function TaskCard({ task }: TaskCardProps) {
    ...
    return(
        <div className="rounded-lg border border-gray-300 py-4">
            <div className="flex items-center gap-5 px-5 cursor-pointer select-none" onClick={() => setExpanded(!isExpanded)}>
                {isTask && (
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="w-[20ch] flex justify-between text-sm text-gray-500">
            ...
            {isExpanded && (
                <div className="p-2 pl-15 flex flex-col gap-4 mt-2 text-sm text-gray-600">
